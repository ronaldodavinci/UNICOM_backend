...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/posts/{postId}/comments": {
            "get": {
                "description": "List comments for a post. Supports pagination via limit and cursor.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "invalid post id or cursor",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    },
        ...
        "/comments/{commentId}": {
            "put": {
                "description": "Update an existing comment (owner or root)",
                "consumes": [
                    "application/json"
                ],
                "produces": [
            ...
            "delete": {
                "description": "Delete a comment (owner or root)",
                "tags": [
                    "comments"
                ],
